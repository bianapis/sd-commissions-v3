...
/**
 * BQCheckInitiateOutputModel
 */
public class BQCheckInitiateOutputModel   {
  private String checkInstanceReference = null;

  private String checkInitiateActionReference = null;
  ...
  **/
   ...
   * @return checkInitiateActionReference
  **/

  public String getCheckInitiateActionReference() {
    return checkInitiateActionReference;
  }

  public void setCheckInitiateActionReference(String checkInitiateActionReference) {
    this.checkInitiateActionReference = checkInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Check instance (e.g. initialised, pending, active) 
